    ...
    <Container>
        <div class="html-block">
            <div class="page-header">
                <Headline title="Datenschutz­erklärung" level={1} levelStyle={1} />
            </div>
            <div class="text-wrapper">
                ...
                <p>HOSTINGER</p>
                <p>Anbieter ist die Hostinger International Ltd., 61 Lordou Vironos Street, 6023 Larnaca, Zypern (nachfolgend Hostinger) Wenn Sie unsere Website besuchen, erfasst Hostinger verschiedene Logfiles inklusive Ihrer IP-Adressen.</p>
                <p>Details entnehmen Sie der Datenschutzerklärung von Hostinger: <br> https://www.hostinger.com/legal/privacy-policy</p>
                ...
                <p>Milan Stojko <br> Wilmersdorfer Str. 122- 123 <br>10627Berlin</p>
                <p>
                    Telefon: 030 53118978 <br>
                    E-Mail: mst@sicherheitsdienst-berlin.com
                </p>
